---
{"MyContainer":"[[2-World/Places/Shop of Sales.md|Shop of Sales]]","MyCategory":null,"tags":["Category/People"],"obsidianUIMode":"preview","aliases":["characters other name"],"NoteStatus":"❓","char_status":"Alive","char_race":"Human","char_gender":"Male","char_items":null,"char_age":"Adult","parents":["Josh","Susan"],"children":["Bob"],"enemies":["Zander"],"allies":["Emyerson","Bob","Frank"],"siblings":["Flip"],"partner":["Jane"],"Connected_Quests":["[[z_Templates/World Builder Templates/Template-Quest.md|Template-Quest]]"],"Connected_Groups":"[[z_Templates/World Builder Templates/Template-Group.md|Template-Group]]","dg-publish":true,"permalink":"/2-world/people/shop-guy/","dgPassFrontmatter":true}
---
...
The following items belong to Shop Guy.
